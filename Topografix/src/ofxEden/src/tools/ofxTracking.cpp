...
std::vector<ofxBlob> ofxTracking::getTrackedBlobs(){
    return trackedBlobs;
}

std::vector<ofxBlob> ofxTracking::getTrackedFingers(){
...
**************************************************************************/
int ofxTracking::trackKnn(ofxContourFinder *newBlobs, ofxBlob *track, int k, double thresh , bool fing){
